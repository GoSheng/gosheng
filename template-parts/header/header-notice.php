...
if ( $GoSheng['gosheng_notice'] ) {
	if ( ! GoSheng_isset_cookie( 'gosheng_notice_closed', 'yes' ) ) {
		?>
        <div id="gosheng_notice" class="alert alert-warning alert-dismissible fade show" role="<?php esc_attr_e( '公告信息', 'GoSheng-framework' ) ?>">
            ...
            <button class="close" aria-label="<?php esc_attr_e( '关闭公告信息', 'GoSheng-framework' ); ?>">
