...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'd-flex justify-content-start align-items-center border rounded shadow-sm bg-light mb-1 mb-lg-2' ); ?>>
    <div class="col-3 p-1 rounded">
        <a href="<?php GoSheng_posted_permalink() ?>" class="d-block rounded" title="<?php GoSheng_posted_title(); ?>">
            <img class="rounded img-fluid" src="<?php GoSheng_posted_thumbnail_url(); ?>"
                 alt="<?php GoSheng_posted_title(); ?>">
        </a>
    ...
    <div class="col-9 p-1">
        <h5 class="p-absolute b-0 b-lg-4">
            <a class="text-body font-8 font-lg-10" title="<?php GoSheng_posted_title(); ?>"
        ...
        <div class="p-absolute d-none d-lg-block b-0 text-indent text-muted font-8 font-lg-9">
            <span><?php GoSheng_posted_excerpt(); ?></span>
        </div>
