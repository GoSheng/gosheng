...
//		),
		...
		array(
			'id'       => 'users_access_logs',
			'type'     => 'switch',
			'title'    => __( '日志记录', 'GoSheng-framework' ),
			'subtitle' => __( '是否开启站点访客记录功能。', 'GoSheng-framework' ),
			'desc'     => __( 'WP根目录下GoSheng_users_access_logs文件夹下是记录文件，按月按日进行文件存储整理。', 'GoSheng-framework' ),
			'on'       => __( '开启', 'GoSheng-framework' ),
			'off'      => __( '关闭', 'GoSheng-framework' ),
			'default'  => true,
		),
		array(
			'id'       => '404_mail',
			'type'     => 'switch',
			'title'    => __( '404页面通知', 'GoSheng-framework' ),
			'subtitle' => __( '是否开启站点404页面访问记录功能。', 'GoSheng-framework' ),
			'desc'     => __( '发送邮件到管理员邮箱，每次404页面访问都发送一封邮件通知。', 'GoSheng-framework' ),
			'on'       => __( '开启', 'GoSheng-framework' ),
			'off'      => __( '关闭', 'GoSheng-framework' ),
			'default'  => true,
		),
